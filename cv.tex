  ...
  \resumeSubHeadingListStart
    ...
    {Johnson \& Johnson}{Remote - US}
      ...
      \resumeItemListStart
        ...
        {Implement various deep learning techniques. Solving business cases, experimenting with image classification, object detection, voice over command, information retrieval.}
      \resumeItemListEnd
    \resumeSubheading
    {SRW\&Co.}{Jakarta}
      ...
      \resumeItemListStart
        ...
        {Helping to develop the Profesi.io web app, ranging from front-end development (VueJS 2 and NuxtJS) to the back-end (AdonisJS 5)}
      \resumeItemListEnd
