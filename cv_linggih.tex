...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    ...
    \href{http://nggih.github.io/}{http://nggih.github.io} & Mobile : +62-877-7666-2583 \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Johnson \& Johnson}{Remote - US}
      {Machine Learning Engineer}{Aug 2021 - Project based}
      \resumeItemListStart
        \resumeItem{Research and Prototyping}
        {Implemented various deep learning and machine learning techniques. Solving business cases, experimenting with image classification, object detection, voice over command, information retrieval.}
      \resumeItemListEnd
    \resumeSubheading
    {SRW\&Co.}{Jakarta}
      {Senior Artificial Intelligence Engineer}{July 2018 - now}
      \resumeItemListStart
        \resumeItem{Research and Prototyping}
        {Implement various deep learning techniques. Mostly working natural language processing (NLP) solutions related to the business cases.}
        \resumeItem{Product Development}
        {Research on the potential applications using AI on the business cases, discuss with the product team}
        \resumeItem{API Deployment}
        {Design, develop and deploy the production grade of AI models using Pytorch on the cloud}
        \resumeItem{Web Development}
        {Helped on Profesi.io web app, handling front-end development (Vue2 \& Nuxt, React \& Next) and the back-end (AdonisJS 5)}
        \resumeItem{DevOps}
        {Used Kubernetes in GCP to deploy the Profesi.io and connected it to Bitbucket pipelines}
      \resumeItemListEnd

    \resumeSubheading
    {Konvergen.AI}{Jakarta}
      {Artificial Intelligence Engineer}{July 2018 - May 2020}
      \resumeItemListStart
        \resumeItem{Research and Prototyping}
        {Implement various deep learning techniques. For examples, image segmentation (semantic and instance), object detection and natural language processing in order to gain the relevant information for the customers. Develop the prototype, validate the results, test the performance of the models.}
        ...
        {Contribute accelerating data collection using synthetic data and pseudotagging. Create retraining platform to alleviate the updating model procedure.}
      \resumeItemListEnd
    ...
    {SAP B1 Junior Consultant}{Dec. 2014 - Oct. 2015}
      \resumeItemListStart
        ...
        {Mapped the client's technical and business requirements. Provided recommendation on technical solutions to implement based on findings. Presented at weekly client meetings to update and flag any potential red flags.}
